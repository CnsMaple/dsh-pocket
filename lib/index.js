...
import { lanEnabled, setLanEnabled, lanAuthEnabled, setLanAuthEnabled, lanIpOverride, setLanIpOverride, pinCustom, setPinCustom, tunnelMode, setTunnelMode, tunnelToken, setTunnelToken, tunnelHostname, setTunnelHostname, resetSettings, proxyPort, cloudflaredPath, feishuWebhook, feishuSecret } from './settings.mjs';
...
export function apply(ctx, config = {}, internals = {}) {
  ...
  void service.startProxy().then((proxy) => {
    ...
    void service.startTunnel().then((url) => {
